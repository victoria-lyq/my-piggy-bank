      ...
      >
        <Center>
          <Icon
            ...
            color={props.selected === 0 ? 'indigo.600' : 'trueGray.600'}
            size="md"
          />
          <Text
            color={props.selected === 0 ? 'indigo.600' : 'trueGray.600'}
      ...
      >
        <Center>
          <Icon
            mb="1"
            as={MaterialIcons}
            color={props.selected === 1 ? 'indigo.600' : 'trueGray.600'}
            name="receipt"
            size="md"
          />
          <Text
      ...
      >
        <Center>
          <Icon
            ...
            color={props.selected === 2 ? 'indigo.600' : 'trueGray.600'}
            size="md"
          />
          <Text
            color={props.selected === 2 ? 'indigo.600' : 'trueGray.600'}
      ...
      >
        <Center>
          <Icon
            mb="1"
            as={MaterialIcons}
            color={props.selected === 3 ? 'indigo.600' : 'trueGray.600'}
